...
/**
 * Kafka Consumer/Producer configuration cho booking-service.
 *
 * <p><b>Consumer:</b> Manual ACK, concurrency=3, DLQ sau 3 retries.
 * <p><b>Producer:</b> acks=all, idempotent, retries=3 – đảm bảo booking events không bị mất.
 */
@Slf4j
@Configuration
public class KafkaConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object>
        ...
        // DLQ: sau 3 lần retry (1s interval) → gửi vào *.DLT topic
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        // Durability: acks=all đảm bảo booking events không bị mất
